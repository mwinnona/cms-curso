	...
	<form class="p-5 bg-light" method="post">
		...
		<div class="form-group">
			...
			<div class="input-group">
				...
				<input type="text" class="form-control" value="<?php echo $usuario["name"]; ?>" placeholder="Escriba su nombre" id="actualizarNombre" name="actualizarNombre">
		...
		if($actualizar == "ok"){
			...
			datos.append("validarToken", "'.md5($_POST["actualizarNombre"]."+".$_POST["actualizarEmail"]).'");
			...
			$.ajax({
				...
				success:function(respuesta){
					...
					$("#actualizarNombre").val(respuesta["name"]);	
