					...
					<div class="container p-0">
						...
						<div class="d-flex">
							...
							<div class="d-flex flex-column columna1">
								...
								<figure class="p-2 m-0 photo1" vinculo="categorias.php">
									
									<p class="text-uppercase p-1 p-md-2 p-xl-1 small">Suramérica</p>

								</figure>

								<figure class="p-2 m-0 photo2" vinculo="categorias.php">
							...
							<div class="d-flex flex-column flex-fill columna2">
								...
								<div class="d-block d-md-flex">
									...
									<figure class="p-2 m-0 flex-fill photo3" vinculo="categorias.php">

										<p class="text-uppercase p-1 p-md-2 p-xl-1 small">Centromérica</p>
										
									</figure>

									<figure class="p-2 m-0 flex-fill photo4" vinculo="categorias.php">
								...
								<figure class="p-2 m-0 photo5" vinculo="categorias.php">
