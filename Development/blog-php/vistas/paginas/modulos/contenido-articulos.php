...
<div class="container-fluid bg-white contenidoInicio py-2 py-md-4">
	...
	<div class="container">
		...
		<ul class="breadcrumb bg-white p-0 mb-2 mb-md-4 breadArticulo">
			...
			<li class="breadcrumb-item inicio"><a href="index.php">Inicio</a></li>

			<li class="breadcrumb-item"><a href="categorias.php">Mi viaje por Suramérica</a></li>
				...
				<div class="container">
					...
					<div>
				 	...
				 	<div class="d-md-flex justify-content-between my-3 d-none">
					    ...
					    <a href="articulos.php">Leer artículo anterior</a>
					    
					    <a href="articulos.php">Leer artículo siguiente</a>
